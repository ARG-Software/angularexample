...
export const ProcessDetailValuesChartModelUIFactory = Factory.makeFactory<ProcessDetailValuesChartModelUI>({
    name: faker.random.word(),
    value: faker.random.number(),
    extra: null
});

export const ProcessDetailChartModelUIFactory = Factory.makeFactory<ProcessDetailChartModelUI>({
    name: faker.random.word(),
    series: ProcessDetailValuesChartModelUIFactory.buildList(3)
});

export const ProcessDetailTableModelUIFactory = Factory.makeFactory<ProcessDetailTableModelUI>({
...
export const ProcessDetailTableInformationModelUIFactory = Factory.makeFactory<ProcessDetailTableInformationModelUI>({
    Information: ProcessDetailTableModelUIFactory.buildList(2),
    Total: faker.random.number()
});

export const ProcessDetailDataModelUIFactory = Factory.makeFactory<ProcessDetailDataModelUI>({

...
import { GetProcessDetailData, GetProcessDetailDataSelectBoxes } from '../../../actions/process-detail.actions';
...
export class ProcessDetailComponent implements OnInit {
    ...
    constructor(
        ...
        this.tablePaging$ = this.store.select(fromReducer.getProcessDetailTablePaging);
        this.machineSelectBoxData$ = this.store.select(fromReducer.getProcessDetailMachineSelectData);
    }

...
export const MessagingLoadDataModelUIFactory = Factory.makeFactory<MessagingLoadDataModelUI>({
...
export const MessagingSaveDataModelUIFactory = Factory.makeFactory<MessagingSaveDataModelUI>({
    Id: faker.random.number(),
    Option: {
        value: faker.random.number(),
        name: faker.random.word(),
...
export const MessagingRequestModelUIFactory = Factory.makeFactory<MessagingRequestModelUI>({
    Id: faker.random.number()
}).build();

...
import {
    ...
    GetMessagingData, GetMessagingDataSuccess
...
export class MessagingEffects {
    ...
    public getMessagingData$ = this.actions$.pipe(
        ...
        switchMap((payload) =>
            ...
            apiRequest()
            .pipe(
                map((response: MessagingLoadDataModelUI[]) => new GetMessagingDataSuccess(MessagingLoadDataModelUIFactory)),
    ...
    public getMessagingDataSuccess$ = this.actions$.pipe(
        ofType<GetMessagingDataSuccess>(MessagingActionTypes.GetMessagingDataSuccess)
    );
    ...
    public updateMessagingSuccess$ = this.actions$.pipe(
        ofType<UpdateMessagingDataSuccess>(MessagingActionTypes.UpdateMessagingDataSuccess)
    );

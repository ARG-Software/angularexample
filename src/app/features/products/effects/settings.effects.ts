...
export class SettingsEffects {
  ...
  public getData$ = this.actions$.pipe(
    ...
    switchMap((payload) =>
      this.settingsService.GetBuffersForProduct(payload).pipe(
        map(
          (response: MimsModels.IBufferDto[]) =>
            new LoadDataSuccess(convertDataInWipUIAndKanBanUIModels(response))
        ),
        finalize(() =>
  ...
  public updateWipData$ = this.actions$.pipe(
    ...
    switchMap((payload: WipDataModelUI[]) =>
      this.settingsService.UpdateWip(payload).pipe(
        map((wipData: boolean) => {
  ...
  public updateWipDataSuccess$ = this.actions$.pipe(
    ofType<UpdateWipSuccess>(SettingsActionTypes.UpdateWipSuccess)
  );
  ...
  public updateKanbanData$ = this.actions$.pipe(
    ...
    switchMap((payload: KanbanDataModelUI[]) =>
      this.settingsService.UpdateKanBan(payload).pipe(

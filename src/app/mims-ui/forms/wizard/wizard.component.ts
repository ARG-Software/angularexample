import { Component,  ViewEncapsulation, Input, ViewChild, ChangeDetectionStrategy, EventEmitter, Output, TemplateRef } from '@angular/core';
...
export class WizardComponent {
  ...
  protected onFinish($event): void {
    this.onWizardFinish.emit();
  }

  protected onNext($event): void {

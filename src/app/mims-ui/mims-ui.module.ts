...
@NgModule({
  imports: [CommonModule, ClarityModule, FormsModule, ReactiveFormsModule, NgxChartsModule],
  declarations: [
    AlertComponent,
    NavbarComponent,
    DataGridComponent,
  ...
  providers: [CommonNavigationService, MimsUiUtilsService, IconService, MimsFormErrorsService],
  exports: [
    AlertComponent,
    NavbarComponent,
    VerticalChartBarComponent,

import { Component, Input, ChangeDetectionStrategy, EventEmitter, Output, forwardRef, ViewEncapsulation, Optional, Inject } from '@angular/core';
...
export class CheckboxComponent extends BaseControlComponent<any> {
    ...
    @Output() public OnChangeSaveInformation: EventEmitter<any> = new EventEmitter();

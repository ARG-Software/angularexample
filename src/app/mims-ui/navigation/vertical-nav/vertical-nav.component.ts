import { Component, OnInit, Input, ChangeDetectionStrategy, Output, ChangeDetectorRef, EventEmitter } from '@angular/core';
...
export class VerticalNavComponent implements OnInit {
  ...
  public ngOnInit(): void {
    this.menuSubscription = this.sideBarService.getMenu(this.menuPath).subscribe(
      (menu) => {
        this.menu = menu;

...
export class LineChartComponent implements OnInit, OnChanges {
  ...
  public ngOnInit(): void {
    this.xAxisLabel = (this.xLabelName !== null && this.xLabelName !== undefined ) ? this.xAxisLabel : '';
    this.yAxisLabel = (this.yLabelName !== null && this.yLabelName !== undefined ) ? this.yLabelName : '';
  }
